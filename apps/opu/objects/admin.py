...
from .models import Object, IP, Point, Outfit, LineType, TPO, TypeOfLocation, TypeOfTrakt, Category, OutfitWorker, \
    MainLineType, AmountChannel, Bug, Transit, Bridge, IPTV
...
class ObjectAdmin(admin.ModelAdmin):
    list_display = ('id', 'id_parent', 'name', 'point1', 'point2', 'amount_channels', 'total_amount_channels')
    search_fields = ('name',)
