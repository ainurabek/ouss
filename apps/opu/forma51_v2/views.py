...
from apps.opu.forma51_v2.models import Forma
from apps.opu.forma51_v2.forms import Forma51Form
...
def create_form51(request, pk):
	...
	if request.method == 'POST':
		...
		if form.is_valid():
			...
			post.save()
			return redirect('apps:opu:forma51_v2:form51_list', slug=region)
	else:
		form = Forma51Form()
