    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_name', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='objects.OutfitWorker', verbose_name='Передал (ФИО)')),
                ...
                ('point1', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='point1_event', to='objects.Point', verbose_name='Ип от')),
                ('point2', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='point2_event', to='objects.Point', verbose_name='Ип до')),
