    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('period_of_time', models.FloatField(blank=True, default=0, null=True)),
                ('bypass', models.BooleanField(default=False)),
                ('arrival_date', models.DateTimeField(blank=True, null=True, verbose_name='Дата приезда бригады')),
                ('downtime', models.CharField(blank=True, max_length=150, null=True, verbose_name='Длителность простоя')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ips', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='objects.Point', verbose_name='ИПы')),
