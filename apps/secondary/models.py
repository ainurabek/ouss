...
class SecondaryBase(models.Model):
    ...
    installed_value = models.CharField('Монтированная емкость', max_length=500, blank=True, null=True)
    active_value = models.CharField('Задействованная емкость', max_length=500, blank=True, null=True)
    active_numbering = models.CharField('Задействованная нумерация', max_length=500, null=True, blank=True)
    free_numbering = models.CharField('Свободная нумерация', max_length=500, blank=True, null=True)
    ...
    KT_numbering = models.CharField('Нумерация КТ', max_length=500, null=True, blank=True)
    comments = models.CharField('Примечание', max_length=500, null=True, blank=True)
